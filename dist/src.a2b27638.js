...
var deletelist = function deletelist(target) {
  document.getElementById("incomplete-list").removeChild(target);
}; //完了リストから指定の要素を削除


var deletelist2 = function deletelist2(target) {
  document.getElementById("complete-list").removeChild(target);
}; //未完了リストに追加する関数


var createIncompleteList = function createIncompleteList(inputText) {
  //div
  var div = document.createElement("div");
  div.className = "list-row"; //li

  var li = document.createElement("li");
  li.innerText = inputText; //buttonその１

  var completeB = document.createElement("button");
  completeB.innerText = "完了";
  completeB.addEventListener("click", function () {
    deletelist(completeB.parentNode); //完了に追記
    //button作成

    var returnB = document.createElement("button");
  ...
  div.appendChild(deleteB); //divを表示
